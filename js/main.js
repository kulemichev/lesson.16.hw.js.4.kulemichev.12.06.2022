...
console.log(getLocalDate(myDate)); // 2/15/2022, 9:35:29 PM
console.log(getLocalDate(myDate, true)); // 2/15/2022, 9:35:29 PM
console.log(getLocalDate(myDate, false, true)); // 2022-02-15, 21:35
console.log(getLocalDate(myDate, true, true)); // 2022-02-15, 21:35:29
 ...
 * #3
 *
 * Создайте функцию getWeekDay(date), которая принимает дату в виде строки
...
let car = new Car(2.5, 'Focus', 'Ford', 1998);
let car2 = new Car(1.8, 'Zafira', 'Opel', 2008);
// let car3 = new Car('Chevrolet','Lacetti', 2021, 2);
